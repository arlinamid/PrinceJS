...
PrinceJS.Credits.prototype = {
  ...
  create: function () {
    (this.tick = 0),
      ...
      (this.tween1 = this.game.add.tween(this.textBack).to({ alpha: 1 }, 2e3, Phaser.Easing.Linear.None, !1, 0, 0, !1)),
      ...
      (this.tween2 = this.game.add
        .tween(this.cropRect)
        .to({ width: this.back.width }, 200, Phaser.Easing.Linear.None, !1, 0, 0, !1)),
      ...
      (this.tween3 = this.game.add
        ...
        .to({ width: this.credits.width }, 200, Phaser.Easing.Linear.None, !1, 0, 0, !1)),
      this.credits.crop(this.cropCredits),
      (this.tween4 = this.game.add.tween(this.credits).to({ alpha: 0 }, 2e3, Phaser.Easing.Linear.None, !1, 0, 0, !1)),
  ...
  update: function () {
    switch (this.tick) {
      ...
      case 1400:
        ...
        break;
      case 1600:
        (this.textBack.visible = this.back.visible = !1), this.tween4.start();
    }
    this.tick++,
      this.back.updateCrop(),
      this.credits.updateCrop(),
      PrinceJS.Utils.continueGame(this.game) && this.play();
  },
  play: function () {
    (PrinceJS.currentLevel = 1), (this.input.keyboard.onDownCallback = null), this.state.start("Game");
  }
};
