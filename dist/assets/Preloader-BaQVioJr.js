...
PrinceJS.Preloader.prototype = {
  ...
  create: function () {
    this.text.setText("Press to Start"),
      ...
      (this.game.input.mouse.capture = !0),
      this.game.input.addPointer(),
      this.game.input.addPointer(),
      this.game.input.gamepad.start(),
      (this.game.canvas.oncontextmenu = function (s) {
        s.preventDefault();
      });
  },
  update: function () {
    PrinceJS.Utils.pointerPressed(this.game) && this.start();
  },
  start: function () {
    PrinceJS.SKIP_TITLE ? this.state.start("Game") : this.state.start("Title");
  }
};
