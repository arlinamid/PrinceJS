PrinceJS.Tile.Potion = function (i, e, n) {
  (this.specialModifier = e),
    (this.isSpecial = e >= PrinceJS.Level.POTION_SPECIAL),
    (e = Math.max(1, Math.min(5, e))),
    PrinceJS.Tile.Base.call(this, i, PrinceJS.Level.TILE_POTION, e, n);
  let t = 53;
  e > 1 && e < 5 && (t -= 4),
    (this.onDrank = new Phaser.Signal()),
    (this.tileChild = this.game.make.sprite(25, t, "general")),
    (this.front.frameName += "_" + e),
    this.front.addChild(this.tileChild),
    (this.step = this.game.rnd.between(0, 6)),
    (this.color = PrinceJS.Tile.Potion.bubbleColors[e - 1]);
};
...
PrinceJS.Tile.Potion.prototype.removeObject = function () {
  ...
  let i = this.game.make.sprite(0, 0, this.key, this.key + "_" + this.element + "_" + this.modifier);
  this.back.addChild(i),
    this.decoration && (this.decoration.destroy(), (this.decoration = void 0)),
    this.isSpecial &&
